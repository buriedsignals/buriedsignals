  ...
  return (
    <>
      <Head>
        ...
        <meta key='og-url' property='og:url' content={ "https://nuanced.ch" + router.asPath } />
        <link rel="canonical" href={ "https://nuanced.ch" + (router.pathname.replace(/\[[^\]]+\]/g, "") + (router.query.slug ? router.query.slug : "" )) } />
      </Head>
    </>
  )
}